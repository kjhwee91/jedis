...
import redis.clients.jedis.worker.Connection;
...
import static redis.clients.jedis.worker.Protocol.Command.*;
import static redis.clients.jedis.worker.Protocol.Keyword.*;
