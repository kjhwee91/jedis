...
import static redis.clients.jedis.support.network.Protocol.Keyword.MESSAGE;
import static redis.clients.jedis.support.network.Protocol.Keyword.PMESSAGE;
import static redis.clients.jedis.support.network.Protocol.Keyword.PSUBSCRIBE;
import static redis.clients.jedis.support.network.Protocol.Keyword.PUNSUBSCRIBE;
import static redis.clients.jedis.support.network.Protocol.Keyword.SUBSCRIBE;
import static redis.clients.jedis.support.network.Protocol.Keyword.UNSUBSCRIBE;
