...
import static redis.clients.jedis.support.network.Protocol.Keyword.ALPHA;
import static redis.clients.jedis.support.network.Protocol.Keyword.ASC;
import static redis.clients.jedis.support.network.Protocol.Keyword.BY;
import static redis.clients.jedis.support.network.Protocol.Keyword.DESC;
import static redis.clients.jedis.support.network.Protocol.Keyword.GET;
import static redis.clients.jedis.support.network.Protocol.Keyword.LIMIT;
import static redis.clients.jedis.support.network.Protocol.Keyword.NOSORT;
