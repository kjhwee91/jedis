...
import static redis.clients.jedis.worker.Protocol.Keyword.ALPHA;
import static redis.clients.jedis.worker.Protocol.Keyword.ASC;
import static redis.clients.jedis.worker.Protocol.Keyword.BY;
import static redis.clients.jedis.worker.Protocol.Keyword.DESC;
import static redis.clients.jedis.worker.Protocol.Keyword.GET;
import static redis.clients.jedis.worker.Protocol.Keyword.LIMIT;
import static redis.clients.jedis.worker.Protocol.Keyword.NOSORT;
